...
def seed_demo_data():
    ...
    # Use a known inspector ID (will be created by auth-service registration)
    # For demo, use a placeholder UUID that you'll replace after registration
    inspector_id = uuid4()
    ...
    print(f"\nIMPORTANT: Replace inspector_id in the DB with your actual inspector ID")
    print(f"  Current demo inspector_id: {inspector_id}")
